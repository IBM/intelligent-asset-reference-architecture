...
<details markdown=1>
<summary markdown="span">Accelerator Catalog</summary>

<table>
    <caption></caption>
    <tr>
        <td> <strong>Name</strong> </td>
        <td>Accelerator Catalog</td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td> <strong>Description</strong> </td>
        <td><p>The AI Broker serves as a centralized hub, facilitating data exchange between MAS and watsonx.ai to support generative, machine learning, and deep learning AI use cases. It provides routing, validation, mediation, and transformation services, connecting client applications to appropriate endpoints, processing input and output data, and ensuring seamless data flow.</p></td>
    </tr>
    <tr>
        <td> <strong>Primary Capability</strong> </td>
        <td><div>application</div></td>
...
<details markdown=1>
<summary markdown="span">Edge Data Collector</summary>

<table>
    <caption></caption>
    <tr>
        <td> <strong>Name</strong> </td>
        <td>Edge Data Collector</td>
    </tr>
    <tr>
        <td> <strong>Description</strong> </td>
        <td><p>IoT device message broker for device registration, IoT data management, and IoT device management. Connect and control IoT devices. Provides secure communication to and from your devices by using MQTT and TLS.</p></td>
...
<table>
    ...
    <tr>
        <td> <strong>Functional Requirement</strong> </td>
        <td><div>MAS Monitor - Maximo Application Suite: Monitor Functional Requirements-uploaded</div></td>
    </tr>
</table>
</details>
...
<table>
    ...
    <tr>
        <td> <strong>Functional Requirement</strong> </td>
        <td><div>MAS Predict - Maximo Application Suite: Predict Functional Requirement-uploaded</div></td>
    </tr>
</table>
</details>
...
<details markdown=1>
<summary markdown="span">Scheduler</summary>
...
<table>
    ...
    <tr>
        <td> <strong>Functional Requirement</strong> </td>
        <td><div>MAS Visual Inspection - Maximo Application Suite: Visual Inspection Functional Requirements-uploaded</div></td>
    </tr>
</table>
</details>
